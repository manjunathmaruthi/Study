...
public class App {
	...
	public void updateLastNameByFirstName(String firstName,String lastName) {
		userDAO.updateLastName(firstName,lastName);
	}

	public void addHobbies(String firstName,List<String> hobiesList){
		userDAO.addHobbiesByFirstName(firstName,hobiesList);
	}
	...
	public static void main( String[] args ){
		...
		//app.updateLastNameByFirstName("Sacha","test");
		List<String> hobiesList = new ArrayList<String>();
		hobiesList.add("test123");
		app.addHobbies("Sacha",hobiesList);
	}
}
